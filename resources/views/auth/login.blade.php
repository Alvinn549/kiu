...
<head>
    ...
    <link rel="stylesheet" crossorigin href="{{ asset('theme/dashboard/assets/compiled/css/app.css') }}">
    <link rel="stylesheet" crossorigin href="{{ asset('theme/dashboard/assets/compiled/css/app-dark.css') }}">
    <link rel="stylesheet" crossorigin href="{{ asset('theme/dashboard/assets/compiled/css/auth.css') }}">
    ...
    <div id="auth">
        ...
        <div class="row h-100">
            ...
            <div class="col-lg-7 d-none d-lg-block">
                <div id="auth-right">
                    <img src="https://images.unsplash.com/photo-1761839259488-2bdeeae794f5?q=80&w=1471&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDF8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                        alt="">
                </div>
            </div>
        </div>
