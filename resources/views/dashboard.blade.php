...
<body>
                                            ...
                                            <div class="col-7">
                                                <div class="d-flex align-items-center">
                                                    <svg class="bi text-primary" width="32" height="32"
                                                        ...
                                                        <use
                                                            xlink:href="theme/dashboard/assets/static/images/bootstrap-icons.svg#circle-fill" />
                                                    </svg>
    ...
    <!-- Need: Apexcharts -->
    <script src="{{ asset('theme/dashboard/assets/extensions/apexcharts/apexcharts.min.js') }}"></script>
    <script src="{{ asset('theme/dashboard/assets/static/js/pages/dashboard.js') }}"></script>
