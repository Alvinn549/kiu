                  ...
                  <div class="dropdown">
                      <a href="#" id="topbarUserDropdown"
                          ...
                          <div class="avatar avatar-md2">
                              <img src="{{ asset('theme/dashboard/assets/compiled/jpg/1.jpg') }}" alt="Avatar">
                          </div>
                          <div class="text">
                      ...
                      <ul class="dropdown-menu dropdown-menu-end shadow-lg" aria-labelledby="topbarUserDropdown">
                          <li>
                              <div
                                  class="dropdown-item theme-toggle d-flex gap-2 align-items-center justify-content-center mt-2">
